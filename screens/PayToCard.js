...
import { StyleSheet, Alert,Text, Linking, CheckBox, Picker, View, TextInput, TouchableOpacity, 
    StatusBar, Image, ToastAndroid, ScrollView, ActivityIndicator, ImageBackground, Button, ActionSheetIOS} from 'react-native';
...
function Index(props){
    ...
    useEffect(()=>{
      console.log(props.route.params.period, "period")
            ...
            <ScrollView style={styles.scrollView}>
                ...
                <View>
                    ...
                    <View style={styles.card}>
                        ...
                        <View style={styles.inputView} >
                            <Text>NOMBRE DEL PROPIETARIO</Text>
                            <TextInput  
                                style={styles.inputText}
                        ...
                        <View style={styles.selects_row}>
                            ...
                            <View style={{ backgroundColor: "#eee", width: "24%", marginRight: 4, borderBottomWidth: 1, borderBottomColor : "#5C101A"}}>

                              {
                                 Platform.OS === "ios" &&
                                    <Button color="#8F0D0F" onPress={onPressCardMonth} title={MonthExpiredCard}/>
                              }
                            ...
                            <View style={{ backgroundColor: "#eee", width: "24%", marginRight: 4,  borderBottomWidth: 1, borderBottomColor : "#5C101A"}}>
                                ...
                                {
                                    Platform.OS === "ios" &&
                                        <Button color="#8F0D0F" onPress={onPressCardYear} title={YearExpiredCard}/>
                                }
                            ...
                            <View style={{ backgroundColor: "#eee", width: "41%", borderBottomWidth: 1, borderBottomColor : "#5C101A"}}>
                                <TextInput  
                                    style={styles.inputText}
                                    placeholder="CVC" 
                                    placeholderTextColor="#777"
